...
namespace API.SignalR
{
    ...
    public class PresenceHub : Hub
    {
        ...
        public async override Task OnConnectedAsync()
        {
            ...
            if(online) await Clients.Others.SendAsync("UserIsOnline", Context.User.GetUsername());
        ...
        public override async Task OnDisconnectedAsync(Exception ex)
        {
            ...
            if(offline) await Clients.Others.SendAsync("UserIsOffline", Context.User.GetUsername());
